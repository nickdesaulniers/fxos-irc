/* http://mozilla.github.io/brick/download.html?byob=appbar,deck,layout,slidebox,tabbar */
window.Platform = {};
var logFlags = {};
! function() {
    function e(e) {
...
if ("undefined" != typeof WeakMap && navigator.userAgent.indexOf("Firefox/") < 0 ? SideTable = WeakMap : function() {
    ...
    function l(e) {
        return L ? L : (L = c(w), L.oldValue = e, L)
    }
        ...
        handleEvent: function(e) {
            switch (e.stopImmediatePropagation(), e.type) {
                ...
                case "DOMNodeInserted":
                    ...
                    var f = p.previousSibling,
                        v = p.nextSibling,
                        o = u("childList", r);
                    o.addedNodes = s, o.removedNodes = c, o.previousSibling = f, o.nextSibling = v, i(r, function(e) {
...
! function(e) {
    function t(t, i) {
        ...
        if (t.indexOf("-") < 0) throw new Error("document.register: first argument `name` must contain a dash ('-'). Argument was '" + String(t) + "'.");
        if (a.name = t, !a.prototype) throw new Error("Options missing required prototype property");
        return a.lifecycle = a.lifecycle || {}, a.ancestry = n(a.extends), r(a), o(a), l(a.prototype), p(t, a), a.ctor = f(a), a.ctor.prototype = a.prototype, a.prototype.constructor = a.ctor, e.ready && e.upgradeAll(document), a.ctor
    }
    ...
    var _ = e.flags,
        g = Boolean(document.webkitRegister || document.register),
        b = !_.register && g;
    if (b) {
        ...
        var E = {}, w = document.createElement.bind(document),
            L = Node.prototype.cloneNode;
        document.register = t, document.createElement = v, Node.prototype.cloneNode = m, e.registry = E, e.upgrade = h
    }
...
function(e) {
    ...
    function n(e, t) {
        for (var n = e.webkitShadowRoot; n;) r(n, t), n = n.olderShadowRoot
    }
    ...
    function s(t) {
        if (!t.__upgraded__ && t.nodeType === Node.ELEMENT_NODE) {
            var n = t.getAttribute("is") || t.localName,
                r = e.registry[n];
            if (r) return E.dom && console.group("upgrade:", t.localName), e.upgrade(t), E.dom && console.groupEnd(), !0
        }
    }

    function c(e) {
        u(e), p(e) && r(e, function(e) {
            u(e)
        })
    }

    function u(e) {
        (e.enteredDocumentCallback || e.__upgraded__ && E.dom) && (E.dom && console.group("inserted:", e.localName), p(e) && (e.__inserted = (e.__inserted || 0) + 1, e.__inserted < 1 && (e.__inserted = 1), e.__inserted > 1 ? E.dom && console.warn("inserted:", e.localName, "insert/remove count:", e.__inserted) : e.enteredDocumentCallback && (E.dom && console.log("inserted:", e.localName), e.enteredDocumentCallback())), E.dom && console.groupEnd())
    }
    ...
    function d(e) {
        (e.leftDocumentCallback || e.__upgraded__ && E.dom) && (E.dom && console.log("removed:", e.localName), p(e) || (e.__inserted = (e.__inserted || 0) - 1, e.__inserted > 0 && (e.__inserted = 0), e.__inserted < 0 ? E.dom && console.warn("removed:", e.localName, "insert/remove count:", e.__inserted) : e.leftDocumentCallback && e.leftDocumentCallback()))
    }

    function p(e) {
        for (var t = e; t;) {
            if (t == e.ownerDocument) return !0;
            t = t.parentNode || t.host
        }
    }

    function f(e) {
        if (e.webkitShadowRoot && !e.webkitShadowRoot.__watched) {
            E.dom && console.log("watching shadow-root for: ", e.localName);
            for (var t = e.webkitShadowRoot; t;) v(t), t = t.olderShadowRoot
        }
    }

    function v(e) {
        e.__watched || (g(e), e.__watched = !0)
    }
    ...
    function y(e) {
        E.dom && console.group("upgradeDocument: ", (e.URL || e._URL || "").split("/").pop()), a(e), E.dom && console.groupEnd()
    }
    var E = window.logFlags || {}, w = new MutationObserver(m),
        L = Array.prototype.forEach.call.bind(Array.prototype.forEach);
    e.watchShadow = f, e.upgradeAll = a, e.upgradeSubtree = i, e.observeDocument = b, e.upgradeDocument = y, e.takeRecords = _
}(window.CustomElements),
...
function() {
    ...
    function l(e) {
        var t = "over" == e;
        return {
            attach: "OverflowEvent" in w ? "overflowchanged" : [],
    ...
    var w = window,
        ...
        C = {
            action: function(e, t) {
                return e.value.match(T).indexOf(String(t.keyCode)) > -1 == ("keypass" == e.name) || null
            }
        }, M = function() {
            var e = w.getComputedStyle(L.documentElement, ""),
        ...
        D = Element.prototype.matchesSelector || Element.prototype[M.lowercase + "MatchesSelector"],
        x = w.MutationObserver || w[M.js + "MutationObserver"],
        S = {}, P = S.toString,
        R = /\s([a-zA-Z]+)/;
    t.object = function(e) {
        var n = {};
    ...
    var U = ["undefined", "null", "number", "boolean", "string", "function"],
        j = "",
        I = {};
    for (var H in document.createEvent("CustomEvent")) I[H] = 1;
    var q = {
        tags: {},
        defaultOptions: {
            pseudos: [],
        ...
        register: function(e, t) {
            ...
            if ("string" == typeof e) {
                ...
                }, i.lifecycle.inserted && (i.prototype.enteredDocumentCallback = {
                ...
                var d = o ? o : t["extends"] ? Object.create(L.createElement(t["extends"]).constructor).prototype : w.HTMLElement.prototype;
                return L.register(r, {
                    "extends": t["extends"],
        ...
        customEvents: {
            ...
            underflow: l("under"),
            animationstart: {
                attach: [M.dom + "AnimationStart"]
            },
            animationend: {
                attach: [M.dom + "AnimationEnd"]
            },
            transitionend: {
                attach: [M.dom + "TransitionEnd"]
            },
            move: {
        ...
        requestFrame: function() {
            var e = w.requestAnimationFrame || w[M.lowercase + "RequestAnimationFrame"] || function(e) {
                    return w.setTimeout(e, 20)
                };
            return function(t) {
                return e.call(w, t)
            }
        ...
        applyPseudos: function(e, t, r, o) {
            var i = t,
                a = {};
            if (e.match(":"))
                for (var s = e.match(O), c = s.length; --c;) s[c].replace(A, function(t, u, l) {
        ...
        fireEvent: function(e, t, n, r) {
            ...
            n = n || {}, r && console.warn("fireEvent has been modified, more info here: "), o.initCustomEvent(t, n.bubbles !== !1, n.cancelable !== !1, n.detail), n.baseEvent && p(o, n.baseEvent);
            try {
                e.dispatchEvent(o)
            } catch (i) {
    ...
    if (w.TouchEvent)
        for (H in B) {
          w.TouchEvent.prototype[H] = B[H];
          //Object.defineProperty(w.TouchEvent.prototype, H, B[H]);
        }
    q.customEvents.tap = {
        observe: {
            mousedown: document,
        ...
        condition: function(e, t) {
            ...
            switch (e.type) {
                ...
                case "touchmove":
                case "touchend":
                    return this.__tap__ && !E(this, t, e) ? (y(this, t), void 0) : "touchend" == e.type || null;
                case "click":
                    return y(this, t), !0
            }
        }
    }, "function" == typeof define && define.amd ? define(q) : w.xtag = q, L.addEventListener("WebComponentsReady", function() {
...
! function() {
    xtag.register("x-appbar", {
        lifecycle: {
            created: function() {
                var e = xtag.queryChildren(this, "header")[0];
                e || (e = document.createElement("header"), this.appendChild(e)), this.xtag.data.header = e, this.subheading = this.subheading
            }
        },
        accessors: {
            heading: {
                ...
                set: function(e) {
                    this.xtag.data.header.innerHTML = e
                }
            },
            subheading: {
                attribute: {},
                ...
                set: function(e) {
                    this.xtag.data.header.setAttribute("subheading", e)
                }
            }
        }
    })
...
! function() {
    function t(t) {
        var e = xtag.query(t, "x-slides > x-slide[selected]")[0] || 0;
        return [e ? xtag.query(t, "x-slides > x-slide").indexOf(e) : e, t.firstElementChild.children.length - 1]
    }

    function e(t, e) {
        var n = xtag.toArray(t.firstElementChild.children);
        n.forEach(function(t) {
            t.removeAttribute("selected")
        }), n[e || 0].setAttribute("selected", !0), t.firstElementChild.style[r] = "translate" + (t.getAttribute("orientation") || "x") + "(" + (e || 0) * (-100 / n.length) + "%)"
    }

    function n(t) {
        var n = this.firstElementChild;
        if (n && n.children.length && "x-slides" == n.tagName.toLowerCase()) {
            var i = xtag.toArray(n.children),
                a = 100 / (i.length || 1),
                o = this.getAttribute("orientation") || "x",
                s = "x" == o ? ["width", "height"] : ["height", "width"];
            if (n.style[s[1]] = "100%", n.style[s[0]] = 100 * i.length + "%", n.style[r] = "translate" + o + "(0%)", i.forEach(function(t) {
                t.style[s[0]] = a + "%", t.style[s[1]] = "100%"
            }), t) {
                var u = n.querySelector("[selected]");
                u && e(this, i.indexOf(u) || 0)
            }
        }
    }
    var r = xtag.prefix.js + "Transform";
    xtag.register("x-slidebox", {
        ...
        events: {
            transitionend: function(t) {
                t.target == this.firstElementChild && xtag.fireEvent(this, "slideend")
            },
            "show:delegate(x-slide)": function(t) {
                var e = t.target;
                if ("x-slides" === e.parentNode.nodeName.toLowerCase() && "x-slidebox" === e.parentNode.parentNode.nodeName.toLowerCase()) {
                    var n = e.parentNode,
                        r = n.parentNode,
                        i = xtag.query(n, "x-slide");
                    r.slideTo(i.indexOf(e))
                }
            }
        },
        accessors: {
            orientation: {
                ...
                set: function(t) {
                    var e = this;
                    xtag.skipTransition(e.firstElementChild, function() {
                        e.setAttribute("orientation", t.toLowerCase()), n.call(e, !0)
                    })
                }
            }
        },
        methods: {
            ...
            slideNext: function() {
                var n = t(this);
                n[0]++, e(this, n[0] > n[1] ? 0 : n[0])
            },
            slidePrevious: function() {
                var n = t(this);
                n[0]--, e(this, n[0] < 0 ? n[1] : n[0])
            }
        }
        ...
        lifecycle: {
            inserted: function() {
                ...
                "x-slidebox" == t.tagName.toLowerCase() && n.call(t, !0)
            },
            created: function() {
                if (this.parentNode) {
                    var t = this.parentNode.parentNode;
